...
import com.spring.basic.dto.Movie;
...
public class MovieService {
	...
	public List<Movie> getMovieByName(String title) throws IOException {
		...
		try {
			...
			movies.add(new Movie(movietitle, description, releseYear, posterUrl, rating, votes, genre, director, actor,
					language));
		} catch (Exception e) {
			movies.add(new Movie("Not Found Please Enter Correct Keyword", "N/A", "N/A",
					"https://img.freepik.com/free-vector/hand-drawn-404-error_23-2147735153.jpg?w=740&t=st=1674586610~exp=1674587210~hmac=9f51d9169e3b17739a0dea1e4726de76eef146ce6dbc5f37967ed3efcc9c5100",
